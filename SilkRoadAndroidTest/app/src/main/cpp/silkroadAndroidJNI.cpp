...
extern jstring utf8ToJString(const char * utf8String);
...
extern "C" const char * silkroad_icudata(const char * ptr);
...
Java_com_chimerasw_silkroadandroidtest_MainActivityKt_uppercase(JNIEnv *env,
    ...
    jstring result = utf8ToJString(silkroad_uppercase(jsonCString));
...
Java_com_chimerasw_silkroadandroidtest_MainActivityKt_jsonpath(JNIEnv *env,
    ...
    jstring result = utf8ToJString(silkroad_jsonpath(pathCString, jsonCString));
...
Java_com_chimerasw_silkroadandroidtest_MainActivityKt_eval(JNIEnv *env,
    ...
    jstring result = utf8ToJString(silkroad_eval(jsCString));
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_chimerasw_silkroadandroidtest_MainActivityKt_icudata(JNIEnv *env,
                                                              jclass clazz,
                                                              jstring jsJString) {
    const char *jsCString = env->GetStringUTFChars(jsJString, nullptr);
    jstring result = utf8ToJString(silkroad_icudata(jsCString));
    env->ReleaseStringUTFChars(jsJString, jsCString);
    return result;
